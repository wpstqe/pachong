...
def postNovelMethod(value):
    result = requests.post(url='https://liu.myfristweb.com/index/cj/savetie', data=value)
    print(result.text)
    try:
...
baseUrl = 'https://192.74.252.135:8900/'
url = 'https://192.74.252.135:8900/bbs/'
...
def mainFun(n):
    ...
    if content is False:
        return False
    try:
        #print(content.find_all(class_='bj_960a')[2].find_all('p')[0].text)
        #titleFont = content.find_all(class_='bj_960a')[2].find_all('p')[0].find_all('font')
        #print(titleFont)
        #print(content.find_all(class_='bj_960a')[2])
        title = content.find_all(class_='bj_960a')[2].text
        print(title)
    ...
    print(title)
    novel = postNovelMethod({'title': title, 'cate': n})
    print(novel)
